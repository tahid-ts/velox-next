...
const CurrencyConverter_two: React.FC = () => {
  ...
  return (
    <div className="w-full lg:max-w-5xl  z-50">
      <LiquidGlass backdropBlur={5} tintColor="#fffff" className="rounded-lg">
        <div className="lg:px-8 px-5 py-6 bg-white">
          <div className="pb-6 ">
          ...
          <div className="grid md:grid-cols-3 gap-8.25 mb-6">
            {/* FROM */}
            <div className="bg-[#03342814] py-2 px-4 rounded-sm w-full">
            ...
            {/* TO */}
            <div className="bg-[#03342814] py-2 px-4 rounded-sm">
            ...
            {/* RATE */}
            <div className="bg-[#03342814] py-2 px-4 rounded-sm flex flex-col items-start justify-center">
              <label className="paragraph-xs text-secondary">
                To This Currency
              </label>
...
export default CurrencyConverter_two;
