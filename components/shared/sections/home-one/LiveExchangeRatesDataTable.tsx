...
const LiveExchangeRatesDataTable: React.FC = ({}) => {
  const columns: ColumnDef<CurrencyData>[] = [
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        const chartValues = [
          { value: row.original.rateByUSD },
          { value: row.original.change24h },
        ];

        return (
          <div className="flex items-center justify-center">
            <SparkLine data={chartValues} strokeColor={color} />
          </div>
        );
      },
    },
...
export default LiveExchangeRatesDataTable;
